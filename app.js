...
app.get('/education', function(req, res){
    ...
    fs.readFile('education.html', (err, data_education) =>{
        res.writeHead(200, {'Content-Type': 'text/html; charset=utf8'});
...
app.get('/writing', function(req, res){
    ...
    fs.readFile('writing.html', (err, data_writing) =>{
        res.writeHead(200, {'Content-Type': 'text/html; charset=utf8'});
...
app.get('/meditation', function(req, res){
    fs.readFile('meditation.html', (err, data_med) =>{
        res.writeHead(200, {'Content-Type': 'text/html; charset=utf8'});
...
app.get('/about', function(req, res){
    fs.readFile('about.html', (err, data_about) =>{
        res.writeHead(200, {'Content-Type': 'text/html; charset=utf8'});
...
app.get('/contact', function(req, res){
    fs.readFile('contact.html', (err, data_contact) =>{
        res.writeHead(200, {'Content-Type': 'text/html; charset=utf8'});
